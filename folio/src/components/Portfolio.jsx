...
const ProjectCard = ({
  ...
  return (
    ...
    >
      <div className='relative w-full md:w-3/5 sm:rounded-lg overflow-hidden'>
        {/* <iframe src={url} title={name} className="h-[50vh] w-full"></iframe> */}
        <div className="w-full absolute bottom-0 flex items-center justify-end p-4">
          <img src={image} alt="open-icon" className="w-auto rounded-md" />
        </div>
      </div>
